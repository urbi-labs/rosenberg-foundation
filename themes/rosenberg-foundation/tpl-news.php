    ...
    ?>
        <div class="internal-intro-section news__last-post ">
            <div class="internal-intro-section__img news__last-post__img">
                <img <?php echo $image ? "srcset='" . $image . "'" : "src='" . $placeholder . "'"   ?> alt="<?php echo esc_html($last_post[0]["post_title"]) ?>" />
            </div>
            <div class="internal-intro-section__content news__last-post__content">
                ...
                <div class="news__last-post__container-text">
                    ...
                    <p>
                        <a href="<?php echo get_permalink($last_post[0]['ID']); ?>">Read more <img src="<?php echo get_template_directory_uri() ?>/images/icon-arrow-right-small-fill.png"></a>
                    </p>
                </div>
                ...
                <div class="card new__list__item">
                    <div class="card__post-featured-image news__featured-image">
                        <a href="<?php the_permalink(); ?>">
                            <img <?php echo $image ? "srcset='" . $image . "'" : "src='" . $placeholder . "'"   ?> alt="<?php echo get_the_title($recent_posts->post->ID); ?>" class="<?php echo !$image ? "news__placeholder" : "" ?>">
                        </a>
                    </div>
