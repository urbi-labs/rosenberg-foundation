...
$args_last_post = array('numberposts' => '1', 'category' => $cat_id);
        ...
        <div class="news__list-categories">
            <ul class="news__list-categories__list">
                ...
                <?php
                        ...
                        ?>
                <li
                    class="news__list-categories__list__item <?php echo $category->term_id == $cat_id ? "news__list-categories__list__item--active" : ""; ?> ">
